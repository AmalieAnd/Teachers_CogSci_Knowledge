...
plot(p_grid, posterior, type ="b", xlab ="probability of riccardo knowing more than chance", ylab = "posterior probability")
...
# Answer:
Setting the mean at chance level (0.5), and sd very low (0.025) minimises wriggle room, thus leaving less up to chance. As we know that the questions were binary, chance plays a great role in this investigation, and must thus be accounted for. The process would only include a change in the prior, which leaves the rest the same.
